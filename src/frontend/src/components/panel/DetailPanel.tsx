...
} from "../ui/MonitoringActionModal.js";
            ...
            >
              ...
              >
                ...
                >
                  <ActionBtn
                    icon={<PlusIcon />}
                    label="Agregar sensor a zona"
                    onClick={onAddSensor}
                  />
                  <ActionBtn
                    icon={<UserPlusIcon />}
                    label="Crear nuevo sensor"
                  ...
                  {hasMonitorings && (
                    <>
                      <ActionBtn
                        ...
                        label="Ver historial de lecturas"
                        onClick={() =>
                          onViewHistory(selectedMonitorings[0]!.id)
                        }
                      />
                      <ActionBtn
                        icon={<PencilIcon />}
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
      ...
      <DetailRow label="Estado">
        <Badge
          status={zone.operational_status === "active" ? "active" : "paused"}
        />
      </DetailRow>
...
function SensorDetail({
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
      ...
      <DetailRow
        label="Tipo"
        value={SENSOR_TYPE_LABELS[sensor.type] ?? sensor.type}
      />
      <DetailRow label="Estado">
        <Badge
          status={anyAlert ? "alert" : (monitorings[0]?.status ?? "active")}
        />
      </DetailRow>
...
function UserPlusIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 14 14" fill="none">
      ...
      <path
        d="M1 12c0-2.5 2-4 5-4M10 9v4M12 11H8"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinecap="round"
      />
...
function TrashIcon() {
  return (
    <svg width="15" height="15" viewBox="0 0 12 12" fill="none">
      <path
        d="M2 3h8M5 3V2h2v1M3 3l.5 7h5L9 3"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinecap="round"
        strokeLinejoin="round"
